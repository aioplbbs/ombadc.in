                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nosvillage" name="nos_village" class="form-control" value="{{old('nos_village')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="nosberneficiaries" class="form-label">Nos Beneficiaries</label>
                                    <input type="text" id="nosberneficiaries" name="nos_beneficiaries" class="form-control" value="{{old('nos_beneficiaries')}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <label for="sanctioned" class="form-label">Sanctioned</label>
                                    <input type="text" id="sanctioned" name="sanctioned" class="form-control" value="{{old('sanctioned')}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="released" class="form-label">Released</label>
                                    <input type="text" id="released" name="released" class="form-control" value="{{old('released')}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="utilised" class="form-label">Utilized</label>
                                    <input type="text" id="utilised" name="utilised" class="form-control" value="{{old('utilised')}}">
                                </div>
                            </div>
                        </div>
