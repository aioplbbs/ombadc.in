            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    <a href="#" class="auth-brand mb-4">
                        <img src="{{session('site_settings')['site_logo']??''}}" alt="dark logo" height="26" class="logo-dark">
                        <img src="{{session('site_settings')['site_logo']??''}}" alt="logo light" height="26" class="logo-light">
                    </a>
