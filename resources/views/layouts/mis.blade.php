...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="wrapper">
            @include('navigation-menu', $breadcrumb)
                    ...
                    <div class="page-container">
                        <div class="row">
                            <div class="col-md-6 text-center text-md-start">
                                <script>document.write(new Date().getFullYear())</script> © All India Online Pvt Ltd.
                                <!-- <span class="fw-bold text-decoration-underline text-uppercase text-reset fs-12">ESIR</span> -->
                            </div>
                            <div class="col-md-6">
                                <div class="text-md-end footer-links d-none d-md-block">
                                    <a href="https://allindiaonline.in/" target="_blank">About</a>
                                    <a href="mailto:support@aio.in">Support Email</a>
                                    <a href="tel:+919437571033">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
