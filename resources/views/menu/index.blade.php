    ...
    <div class="page-container">
        <div class="card">
            <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                ...
                @can('create menu')
                <a href="{{route('menu.create', [$setting->id])}}" class="btn btn-primary btn-sm" > Add Menu </a>
                @endcan
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive-sm">
                    <div class="dd" id="nestable">
                        <ol class="dd-list">
                            @if(!empty($menus))
                            @include('menu.hierarchical-list', ['items' => $menus])
                            @endif
                        </ol>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#saveMenu').on('click', function() {
                ...
                // Send via POST
                $.post({
                    url: "{{route('menus.update_position', ['setting' => $setting->id])}}", // <-- change to your Laravel route
                    data: {
